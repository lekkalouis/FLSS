...
export const config = {
  ...
  PP_TIMEOUT_MS: Number(process.env.PP_TIMEOUT_MS || 10000),
  ...
  SHOPIFY_TIMEOUT_MS: Number(process.env.SHOPIFY_TIMEOUT_MS || 10000),
  ...
  PRINTNODE_TIMEOUT_MS: Number(process.env.PRINTNODE_TIMEOUT_MS || 10000),
