...
export const config = {
  ...
  SHOPIFY_THROTTLE_MAX_CONCURRENCY: Number(process.env.SHOPIFY_THROTTLE_MAX_CONCURRENCY || 4),
  SHOPIFY_THROTTLE_BASE_DELAY_MS: Number(process.env.SHOPIFY_THROTTLE_BASE_DELAY_MS || 250),
  SHOPIFY_THROTTLE_MAX_DELAY_MS: Number(process.env.SHOPIFY_THROTTLE_MAX_DELAY_MS || 5000),
  SHOPIFY_THROTTLE_CALL_LIMIT_RATIO: Number(process.env.SHOPIFY_THROTTLE_CALL_LIMIT_RATIO || 0.85),
