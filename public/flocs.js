(() => {
  ...
  const CONFIG = {
    ...
    PRODUCTS: window.FLSS_PRODUCT_UTILS?.products || window.FLSS_PRODUCTS || []
  };
  ...
  function renderProductsTable() {
    ...
    productsBody.innerHTML = filtered
      .map((p) => {
        ...
        const flavourColor =
          p.flavourColor ||
          window.FLSS_PRODUCT_UTILS?.getFlavorColor?.(p.flavour) ||
          "#cbd5f5";
        return `
        <tr class="flocs-productRow" style="border-left:4px solid ${flavourColor};">
